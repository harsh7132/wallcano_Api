...
class God_wallpaper extends StatefulWidget {
  @override
  State<God_wallpaper> createState() => _God_wallpapertate();
}

class _God_wallpapertate extends State<God_wallpaper> {
  var myKey = "563492ad6f917000010000014276de82636b417392addf236e34b96d";
  var searchController = TextEditingController();
  late Future<WallpaperModel> Godwallpaper;
  late Future<PhotosModel> photo;
  @override
  void initState() {
    super.initState();
    Godwallpaper = getWallpaper('gods');
    photo = getPhotos();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title:
              Padding(padding: EdgeInsets.only(left: 90), child: Text('God'))),
  ...
  Future<WallpaperModel> getWallpaper(String mysearch) async {
    ...
    if (response.statusCode == 200) {
      var God_wallpaper = jsonDecode(response.body);
      return WallpaperModel.fromJson(God_wallpaper);
    } else {
      showDialog(
          context: context,
