...
class My_App extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Music_wallpaper(),
    );
  }
}

class Music_wallpaper extends StatefulWidget {
  @override
  State<Music_wallpaper> createState() => _Music_wallpapertate();
}

class _Music_wallpapertate extends State<Music_wallpaper> {
  var myKey = "563492ad6f917000010000014276de82636b417392addf236e34b96d";
  var searchController = TextEditingController();
  late Future<WallpaperModel> Musicwallpaper;
  late Future<PhotosModel> photo;
  @override
  void initState() {
    super.initState();
    Musicwallpaper = getWallpaper('Music');
    photo = getPhotos();
  }
  ...
  Future<WallpaperModel> getWallpaper(String mysearch) async {
    ...
    if (response.statusCode == 200) {
      var Music_wallpaper = jsonDecode(response.body);
      return WallpaperModel.fromJson(Music_wallpaper);
    } else {
      showDialog(
          context: context,
  ...
  Future<PhotosModel> getPhotos() async {
    var URL = "https://api.pexels.com/v1/search?query=music&per_page=21";
    var response =
