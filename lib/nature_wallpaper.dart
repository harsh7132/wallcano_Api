...
class My_App extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Nature_wallpaper(),
    );
  }
}

class Nature_wallpaper extends StatefulWidget {
  @override
  State<Nature_wallpaper> createState() => _Nature_wallpapertate();
}

class _Nature_wallpapertate extends State<Nature_wallpaper> {
  var myKey = "563492ad6f917000010000014276de82636b417392addf236e34b96d";
  var searchController = TextEditingController();
  late Future<WallpaperModel> Naturewallpaper;
  late Future<PhotosModel> photo;
  @override
  void initState() {
    super.initState();
    Naturewallpaper = getWallpaper('nature');
    photo = getPhotos();
  }
  ...
  Future<WallpaperModel> getWallpaper(String mysearch) async {
    ...
    if (response.statusCode == 200) {
      var Nature_wallpaper = jsonDecode(response.body);
      return WallpaperModel.fromJson(Nature_wallpaper);
    } else {
      showDialog(
          context: context,
  ...
  Future<PhotosModel> getPhotos() async {
    var URL = "https://api.pexels.com/v1/search?query=nature&per_page=21";
    var response =
